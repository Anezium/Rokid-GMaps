...
object ProtocolConstants {
    ...
    const val FIELD_ROUTE_MODE = "routeMode"
    ...
    const val FIELD_SHOW_LANDMARKS = "showPois"
    const val FIELD_PREVIEW_ACTIVE = "preview"
    const val FIELD_POIS = "pois"
