...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PREF_SHOW_LANDMARKS = "show_landmarks"
    ...
    private lateinit var switchShowLandmarks: Switch
    ...
    private fun bindViews() {
        ...
        switchShowLandmarks = findViewById(R.id.switchShowLandmarks)
        switchShowLandmarks.isChecked = getSharedPreferences(PREFS_HUD, MODE_PRIVATE).getBoolean(PREF_SHOW_LANDMARKS, true)
    ...
    private fun setupListeners() {
        ...
        switchShowLandmarks.setOnCheckedChangeListener { _, isChecked ->
            getSharedPreferences(PREFS_HUD, MODE_PRIVATE).edit().putBoolean(PREF_SHOW_LANDMARKS, isChecked).apply()
            sendCurrentSettings()
        }
    ...
    private fun sendCurrentSettings() {
        ...
        service?.sendSettings(
            ...
            routeMode = ProviderPrefs.getRouteMode(this).prefValue,
            ...
            showLandmarks = hudPrefs.getBoolean(PREF_SHOW_LANDMARKS, true)
        )
    }
