        ...
        when (val parsed = ProtocolCodec.decode(line)) {
            ...
            is ParsedMessage.Settings -> {
                ...
                currentState = currentState.copy(
                    ...
                    routeMode = parsed.msg.routeMode,
                    ...
                    showLandmarks = parsed.msg.showLandmarks
                )
            }
            ...
            is ParsedMessage.NavMode -> {
                currentState = currentState.copy(
                    previewActive = parsed.msg.previewActive
                )
            }
            is ParsedMessage.Pois -> {
                currentState = currentState.copy(
                    landmarks = parsed.msg.items
                )
            }
